 ...
 */
const getAllBoards = async (): Promise<Board[]> => boardData;
 ...
 */
const addBoard = async (data: Board): Promise<Board> => {
 ...
 */
const updateBoard = async (boardId: string, data: Board): Promise<string> => {
...
const deleteBoard = async (id: string): Promise<void> => {
  ...
  if (i >= 0) {
    ...
    await tasksRepo.deleteTasksOnBoardDeletion(id);
  }
};
